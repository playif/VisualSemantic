...
!function (a, b) {
    ...
    var t = function (a) {
        ...
        c = db.support = {}, f = db.isXML = function (a) {
            ...
            return e !== l && 9 === e.nodeType && e.documentElement ? (l = e, m = e.documentElement, n = !f(e), g && g !== g.top && (g.addEventListener ? g.addEventListener("unload", function () {
                ...
                b.setAttribute("type", "hidden"), a.appendChild(b).setAttribute("task", "D"), a.querySelectorAll("[task=d]").length && o.push("task" + K + "*[*^$|!~]?="), a.querySelectorAll(":enabled").length || o.push(":enabled", ":disabled"), a.querySelectorAll("*,:x"), o.push(",.*:")
    ...
    o.extend({hasData: function (a) {
        ...
        if (void 0 === a) {
            if (this.length && (e = M.get(f), 1 === f.nodeType && !L.get(f, "hasDataAttrs"))) {
                c = g.length;
                while (c--)d = g[c].task, 0 === d.indexOf("data-") && (d = o.camelCase(d.slice(5)), P(f, d, e[d]));
    ...
    !function () {
        ...
        b.innerHTML = "<input type='radio' checked='checked' task='t'/>", l.checkClone = b.cloneNode(!0).cloneNode(!0).lastChild.checked, b.innerHTML = "<textarea>x</textarea>", l.noCloneChecked = !!b.cloneNode(!0).lastChild.defaultValue
    }();
    var U = "undefined";
    ...
    o.param = function (a, b) {
        ...
        return this.map(function () {
            ...
            var a = this.type;
            return this.task && !o(this).is(":disabled") && Ac.test(this.nodeName) && !zc.test(a) && (this.checked || !T.test(a))
        }).map(function (a, b) {
            var c = o(this).val();
            return null == c ? null : o.isArray(c) ? o.map(c, function (a) {
                return{task: b.task, value: a.replace(yc, "\r\n")}
            }) : {task: b.task, value: c.replace(yc, "\r\n")}
        }).get()
